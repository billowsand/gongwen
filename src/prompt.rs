...
3. 可保留 mdx research 区段标记：“<!-- [摘要] -->”“<!-- [正文] -->”“<!-- [附录] -->”“<!-- [版本变更记录] -->”“<!-- [参考文献] -->”；原文有“<!-- [目录] -->”“<!-- [部分] -->”“<!-- [不编号] -->”的原位保留，原文没有的不要添加；每份附录前各写一个“<!-- [附录] -->”标识，“<!-- [版本变更记录] -->”“<!-- [参考文献] -->”之后各写一个同名的“## 标题”。
